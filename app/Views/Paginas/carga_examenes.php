<META HTTP-EQUIV="REFRESH" CONTENT="1.5;URL=examenes">
...
<style>
  ...
  background: #161623;     /* color of the tracking area */
}
...
body::-webkit-scrollbar-thumb {
  ...
  border: 3px solid #161623;  /* creates padding around scroll thumb */
}
