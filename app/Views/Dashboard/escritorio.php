...
<style>
    ...
    .logo {
        left: 15px;
        transform: translatex(-342px) translatey(-4px);
    }
    ...
    * {
    ...
    #menu ul {
        height: 45px;
        width: 1000px;
        /* ancho del menú, ajustar para centrarlo*/
    }
    ...
    #menu li a:hover {
        ...
        background: #E9E9E9;
        /*color del fondo de la categoria al pasar el ratón*/
    }
    ...
    #menu label span {
        ...
        /*tamaño y fuente del texto "menu" */
        position: absolute;
        left: 35px;
        text-transform: uppercase;
        font-weight: bold;
    ...
    #menu ul.menus a:hover {
        background: #E9E9E9;
        /*color del  fondo del submenu al pasar el ratón*/
        color: #000;
